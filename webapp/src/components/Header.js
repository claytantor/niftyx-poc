...
import { xummConfig, deploymentEnv } from "../env";
...
const Header = ({
    ...
    return (
      <div className="w-full">
            ...
            {isAuthorized ?
            <div className="bg-slate-700 flex fle-row justify-between items-center p-1">
            ...
            <div className="bg-slate-700 flex flex-row justify-end items-center">
                <div>
                    <div>
